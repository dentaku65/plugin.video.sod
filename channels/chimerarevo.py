...
def mainlist(item):
    ...
    itemlist = []
    itemlist.append(Item(channel=__channel__, title="[COLOR azure]News, guide e recensioni tecnologiche[/COLOR]",
                         action="peliculas", url="http://www.chimerarevo.com/video/",
